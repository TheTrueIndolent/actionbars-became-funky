	...
	_G["abfOptions5aBox1PopOut4Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Top"]["AnimationColorOptions"] == "Class Color" then
				...
				abfSavedTopArtAnimation("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["Top"]["AnimationColorOptions"] == "Faction Color" then
				ABFactionBars["Bar5"]["Top"]["AnimationColor"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				abfSavedTopArtAnimation("Bar5", MultiBarLeft)
	...
	_G["abfOptions5aBox2PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Top"]["ArtColorOptions"] == "Class Color" then
				...
				if abfOptions5aBox2Slider1:IsShown() then abfOptions5aBox2Slider1:Hide() end
				abfSavedColorTop("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["Top"]["ArtColorOptions"] == "Faction Color" then
				ABFactionBars["Bar5"]["Top"]["ArtColor"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				if abfOptions5aBox2Slider1:IsShown() then abfOptions5aBox2Slider1:Hide() end
				abfSavedColorTop("Bar5", MultiBarLeft)
	...
	_G["abfOptions5aBox3PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Top"]["ArtGradientOptions1"] == "Class Color" then
				...
				abfSavedColorTop("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["Top"]["ArtGradientOptions1"] == "Faction Color" then
				ABFactionBars["Bar5"]["Top"]["ArtGradientColor1"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				abfSavedColorTop("Bar5", MultiBarLeft)
	...
	_G["abfOptions5aBox3PopOut2Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Top"]["ArtGradientOptions2"] == "Class Color" then
				...
				abfSavedColorTop("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["Top"]["ArtGradientOptions2"] == "Faction Color" then
				ABFactionBars["Bar5"]["Top"]["ArtGradientColor2"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				abfSavedColorTop("Bar5", MultiBarLeft)
	...
	_G["abfOptions5aBox4PopOut4Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Bottom"]["AnimationColorOptions"] == "Class Color" then
				...
				--abfSavedAnimationBottomColor("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["Bottom"]["AnimationColorOptions"] == "Faction Color" then
				ABFactionBars["Bar5"]["Bottom"]["AnimationColor"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				--abfSavedAnimationBottomColor("Bar5", MultiBarLeft)
	...
	_G["abfOptions5aBox5PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Bottom"]["ArtColorOptions"] == "Class Color" then
				...
				if abfOptions5aBox5Slider1:IsShown() then abfOptions5aBox5Slider1:Hide() end
				abfSavedColorBottom("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["Bottom"]["ArtColorOptions"] == "Faction Color" then
				ABFactionBars["Bar5"]["Bottom"]["ArtColor"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				if abfOptions5aBox5Slider1:IsShown() then abfOptions5aBox5Slider1:Hide() end
				abfSavedColorBottom("Bar5", MultiBarLeft)
	...
	_G["abfOptions5aBox6PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Bottom"]["ArtGradientOptions1"] == "Class Color" then
				...
				abfSavedColorBottom("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["Bottom"]["ArtGradientOptions1"] == "Faction Color" then
				ABFactionBars["Bar5"]["Bottom"]["ArtGradientColor1"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				abfSavedColorBottom("Bar5", MultiBarLeft)
	...
	_G["abfOptions5aBox6PopOut2Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Bottom"]["ArtGradientOptions2"] == "Class Color" then
				...
				abfSavedColorBottom("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["Bottom"]["ArtGradientOptions2"] == "Faction Color" then
				ABFactionBars["Bar5"]["Bottom"]["ArtGradientColor2"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				abfSavedColorBottom("Bar5", MultiBarLeft)
	...
	_G["abfOptions5aBox8PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["NormalTextureColorOptions"] == "Class Color" then
				...
				abfSavedColorNormalTexture("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["NormalTextureColorOptions"] == "Faction Color" then
				ABFactionBars["Bar5"]["NormalTextureColor"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				abfSavedColorNormalTexture("Bar5", MultiBarLeft)
	...
	_G["abfOptions5aBox9PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["NormalTextureGradientOptions1"] == "Class Color" then
				...
				abfSavedColorNormalTexture("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["NormalTextureGradientOptions1"] == "Faction Color" then
				ABFactionBars["Bar5"]["NormalTextureGradient1"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				abfSavedColorNormalTexture("Bar5", MultiBarLeft)
	...
	_G["abfOptions5aBox9PopOut2Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["NormalTextureGradientOptions2"] == "Class Color" then
				...
				abfSavedColorNormalTexture("Bar5", MultiBarLeft)
			elseif ABFactionBars["Bar5"]["NormalTextureGradientOptions2"] == "Faction Color" then
				ABFactionBars["Bar5"]["NormalTextureGradient2"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				abfSavedColorNormalTexture("Bar5", MultiBarLeft)
