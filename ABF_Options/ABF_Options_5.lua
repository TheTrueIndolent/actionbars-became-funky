...
for i = 0, 3, 1 do
	_G["abfOptions5Box1PopOut4Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["ColorCDoption"] == "Faction Color" then
				ABFactionBars["Bar5"]["ColorCD"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
...
for i = 0, 3, 1 do
	_G["abfOptions5Box3PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Slot"]["ArtColorOptions"] == "Faction Color" then
				if abfOptions5Box3Slider1:IsShown() then abfOptions5Box3Slider1:Hide() end
				ABFactionBars["Bar5"]["Slot"]["ArtColor"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
...
for i = 0, 3, 1 do
	_G["abfOptions5Box4PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Slot"]["ArtGradientOptions1"] == "Faction Color" then
				ABFactionBars["Bar5"]["Slot"]["ArtGradientColor1"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
...
for i = 0, 3, 1 do
	_G["abfOptions5Box4PopOut2Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Slot"]["ArtGradientOptions2"] == "Faction Color" then
				ABFactionBars["Bar5"]["Slot"]["ArtGradientColor2"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
...
for i = 0, 3, 1 do
	_G["abfOptions5Box5PopOut4Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Edge"]["AnimationColorOptions"] == "Faction Color" then
				ABFactionBars["Bar5"]["Edge"]["AnimationColor"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
	...
	_G["abfOptions5Box6PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Edge"]["ArtColorOptions"] == "Class Color" then
				...
				if abfOptions5Box6Slider1:IsShown() then abfOptions5Box6Slider1:Hide() end
			elseif ABFactionBars["Bar5"]["Edge"]["ArtColorOptions"] == "Faction Color" then
				ABFactionBars["Bar5"]["Edge"]["ArtColor"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
				if abfOptions5Box6Slider1:IsShown() then abfOptions5Box6Slider1:Hide() end
...
for i = 0, 3, 1 do
	_G["abfOptions5Box7PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Edge"]["ArtGradientOptions1"] == "Faction Color" then
				ABFactionBars["Bar5"]["Edge"]["ArtGradientColor1"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
...
for i = 0, 3, 1 do
	_G["abfOptions5Box7PopOut2Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["Edge"]["ArtGradientOptions2"] == "Faction Color" then
				ABFactionBars["Bar5"]["Edge"]["ArtGradientColor2"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
...
for i = 0, 3, 1 do
	_G["abfOptions5Box9PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["BorderArtColorOptions"] == "Faction Color" then
				ABFactionBars["Bar5"]["BorderArtColor"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
...
for i = 0, 3, 1 do
	_G["abfOptions5Box10PopOut1Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["BorderArtGradientOptions1"] == "Faction Color" then
				ABFactionBars["Bar5"]["BorderArtGradient1"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
...
for i = 0, 3, 1 do
	_G["abfOptions5Box10PopOut2Choice"..i]:HookScript("OnClick", function(self, button, down)
		if button == "LeftButton" and down == false then
			...
			elseif ABFactionBars["Bar5"]["BorderArtGradientOptions2"] == "Faction Color" then
				ABFactionBars["Bar5"]["BorderArtGradient2"] = CreateColor(_G["PLAYER_FACTION_COLOR_"..string.upper(abfFaction.name)]:GetRGB())
