...
local function Slots(text, bar)
	abfSavedArtSlot(text, bar)
	abfSavedColorSlot(text, bar)
end
-- Events time --
local function EventsTime(self, event, arg1, arg2, arg3)
	if event == "PLAYER_LOGIN" then
		ArtSlot()
-- loading... --
		Slots("Bar1", MainMenuBar)
		Slots("Bar2", MultiBarBottomLeft)
		Slots("Bar3", MultiBarBottomRight)
		Slots("Bar4", MultiBarRight)
		Slots("Bar5", MultiBarLeft)
		Slots("Bar6", MultiBar5)
		Slots("Bar7", MultiBar6)
		Slots("Bar8", MultiBar7)
	end
end
