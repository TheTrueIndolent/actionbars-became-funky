...
local function Top(text, bar)
	abfSavedArtTop(text, bar)
	abfSavedColorTop(text, bar)
end
-- Events time --
local function EventsTime(self, event, arg1, arg2, arg3)
	if event == "PLAYER_LOGIN" then
		ArtTop()
-- loading... --
		Top("Bar1", MainMenuBar)
		Top("Bar2", MultiBarBottomLeft)
		Top("Bar3", MultiBarBottomRight)
		Top("Bar4", MultiBarRight)
		Top("Bar5", MultiBarLeft)
		Top("Bar6", MultiBar5)
		Top("Bar7", MultiBar6)
		Top("Bar8", MultiBar7)
	end
